...
if(empty($_SESSION['id'])){
    ...
    $pdo = new PDO("mysql:dbname=lesson02;host=localhost;","root","Nhuhao939393");
...
if(!empty($_SESSION['id']) && !empty($_SESSION['login_remember'])){
    setcookie('mail',$_SESSION['mail'],time()+60*60*24*7);
    setcookie('password',$_SESSION['password'],time()+60*60*24*7);
    setcookie('login_remember',$_SESSION['login_remember'],time()+60*60*24*7);
  
  } else  if(empty($_SESSION['login_remember'])){
    setcookie('mail','',time()-1);
    setcookie('password','',time()-1);
    setcookie('login_remember','',time()-1);
  }
